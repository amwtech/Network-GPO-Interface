...
#define _MAC_ADDRESS_START 0x00     // EEPROM addresses for the MAC
#define _MAC_ADDRESS_LENGTH 0x06

// Storage for the pin invert data
#define _OUTPUT_INVERT 0x10

// Each IP address set contains five sub-fields - IP address (4 bytes), 
// Subnet-mask (4 bytes), Router address (4 bytes), Gateway address and 
// UDP Port (2 bytes).
